...
def gen(env_name = 'BipedalWalker-v3',algorithm = 'PPO', episode = 10, called = 'state', label = state_L, dimension = 24, fig_width = 2,
    ...
    for num in range(1):
        ...
        np.save("D:\RL\PPO-PyTorch-master\B_gen_s_all.npy", gen_s_all)
