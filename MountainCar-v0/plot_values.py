...
state_L = ['position', 'velocity']
action_L = ['main engine', 'left-right engines']

def save_graph(env_name = 'MountainCar-v0',algorithm = 'DuelingDQN', episode = 10, called = 'state', label = state_L, dimension = 2, fig_width = 1,
    fig_height = 2,figsize = (10, 4)):
