...
# DQN
def save_graph(env_name = 'LunarLander-v2',algorithm = 'AC', episode = 10, called = 'state', label = state_L, dimension = 8, fig_width = 4,
    fig_height = 2,figsize = (10, 8)):
    ...
    plt.suptitle(env_name + "_" + algorithm + " (SBCov1 = {}, SBCov2 = {})".format(round(avg_coverage1, 3), round(avg_coverage2, 5)))
